...
class User:
    ...
    def __init__(self, client: Client, data: dict) -> None:
        ...
        # New API format uses core.created_at, fallback to legacy.created_at
        ...
        self.verified: bool = data.get('verification', {}).get('verified') or legacy.get('verified', False)
        self.possibly_sensitive: bool = legacy.get('possibly_sensitive', False)
        self.can_dm: bool = (
            data.get('dm_permissions', {}).get('can_dm') or
            legacy.get('can_dm', False)
        )
        self.can_media_tag: bool = (
            data.get('media_permissions', {}).get('can_media_tag') or
        ...
        self.protected: bool = (
            data.get('privacy', {}).get('protected') or
